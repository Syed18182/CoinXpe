...
export class DelUserTable extends Component {
  constructor(props) {
    super(props);
    this.state = {
      show: false,
          ...
          <div className="col-lg-12">
            <div className="card py-4">
              <div className="card-title">
                <h2>
                  <b className="d-flex justify-content-center">Delete Users</b>
                </h2>
              </div>
                          ...
                          <tr key={key}>
                            ...
                            <td
                              ...
                              onClick={(e) => {
                                axios
                                  .post(
                                    "http://localhost:8000/deleteUserbyAdmin",
                                    {
                                      email: val["email"],
                                  ...
                                  .then(async (res) => {
                                    ...
                                    axios
                                      .get(
                                        "http://localhost:8000/getAllDelUsers"
                                      )
                                      .then(async (res) => {
                                        this.props.updateDelData(
                                          await res["data"]
                                        );
                                        this.props.updateDelMainData(
                                          await res["data"]
                                        );
                                      });
